module github.com/ShreyanshMehta/Go-Concurrency-Patterns/errgroup
...
replace (
	github.com/blang/semver/v4 => github.com/carvel-dev/semver/v4 v4.0.0
	github.com/kcp-dev/apimachinery/v2 => github.com/kcp-dev/apimachinery/v2 v2.0.0-alpha.0.0.20230113171111-a259d60637ec
	...
	sigs.k8s.io/controller-runtime => github.com/kcp-dev/controller-runtime v0.12.2-0.20230210133534-6a34cae9a543
)
